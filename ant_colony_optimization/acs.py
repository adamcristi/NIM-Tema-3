...
class Ant:
    ...
    def choose_next_node(self):
        if len(self.unvisited_nodes) == 0:
            ...
            for possible_node in self.unvisited_nodes:
                ...
                pheromone_trail_node = self.get_pheromone_trail_node(node=self.current_node, adjacency_node=possible_node)
            ...
            best_possible_nodes = []
            #for index_node, node in enumerate(possible_nodes):
    ...
    def colorize(self):
        ...
        for index in range(num_unvisited_nodes):
            ...
            #self.matrix_pheromones_trails[self.current_node, next_node] = (1 - self.ro) * self.matrix_pheromones_trails[self.current_node, next_node] + \
            #                                                              self.ro *
...
class AntColonySystem:
    ...
    def initialize_colours_nodes(self):
        ...
        #counter_different_degrees_nodes = len(set(np.sum(self.matrix_adjacency, axis=1)))
